...
class User {
    ...
    constructor(name, gender, birth, country, email, password, photo, admin) {
        ...
        this._id;
        this._name = name;       //O underline "_" (modificadores de acesso) indica que a propriedade é privada e só deve ser acessada através de métodos.
        this._gender = gender;  //A isso tmb damos o nome de ENCAPSULAMENTO
        this._birth = birth;
